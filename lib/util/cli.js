...
function print(object) {
  var nodeVersionMajor = Number(process.version.substring(1, process.version.indexOf('.')));
  if (util.isError(object)) {
    ...
    console.log(nodeVersionMajor > 8 ? util.formatWithOptions({ colors: false }, object) : object);
  } else {
    console.log();
  }
}
